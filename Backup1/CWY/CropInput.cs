...
namespace CWY
{
  ...
  public class CropInput : UserControl
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.dgIrrigation.Size = new Size(277, 0);
      ...
      this.cdgOperationCosts.EndInit();
    ...
    public void CropAction()
    {
      ...
      this.lblPriceUnits.Text = "$/" + this.ActiveCrop.Units();
    ...
    {
      this.label18.Text = "$ / " + this.model.fuelunits;
    ...
    {
      this.lblIrrigCost.Text = "$" + this.ActiveCrop.IrrigationCost(this.model)[1].ToString("0.00") + "/acre-inch";
    }
