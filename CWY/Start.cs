...
namespace CWY
{
  public class Start : Form
  {
    ...
    private void ShowHelp(string url)
    {
      if (url == "")
        url = "index.html";
      Help.ShowHelp((Control) this, "C:\\Users\\Rajathnavada\\Documents\\FinalYear\\KSWB\\CYP.chm", HelpNavigator.Topic,"index.htm");
    }

    private void button1_Click(object sender, EventArgs e)
    {
      this.ShowHelp("C:\\Users\\Rajathnavada\\Documents\\FinalYear\\KSWB\\CYP.chm");
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.label4.Text = "Sannidhi Mujumdar";
      ...
      this.label2.Text = "The Crop Yield Predictor is handy tool to get agricultural yield analysis based on past data.";
