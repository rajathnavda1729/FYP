    ...
    public class frmMain : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.tpLocation.Name = "tpLocation";
            Console.WriteLine("the location is", tpLocation.Name);
    ...
    private void LoadCWYModel(CWYModel c)
    {
      ...
      ArrayList dataSource1 = (ArrayList) this.lstLocations.DataSource;
            ...
            //Console.WriteLine("common", dataSource1[0]);
      for (int index2 = 0; index2 < dataSource1.Count; ++index2)
      {
        if (((LocationData) dataSource1[index2]).LocationName == c.cLocation.LocationName)
        {
          ...
          this.lstLocations.SelectedIndex = index2;
                    Console.WriteLine("The index is", dataSource1[index2]);
      ...
      try
      {
        ...
        switch (lower)
        {
          case "uttarpradesh":
            ...
            numArray[2] = 20.0;
            numArray[3] = 16.0;
            this.pictureBox1.Image = (Image)Resources.uttarpradesh;
          ...
          case "madhyapradesh":
            ...
            numArray[2] = 24.0;
            numArray[3] = 18.0;
            this.pictureBox1.Image = (Image)Resources.madhyapradesh;
            break;
          case "punjab":
            numArray[0] = 18.0;
            numArray[1] = 23.0;
            numArray[2] = 27.0;
            numArray[3] = 23.0;
            this.pictureBox1.Image = (Image)Resources.punjab;
            break;
          case "andhrapradesh":
            numArray[0] = 12.0;
            numArray[1] = 16.0;
            numArray[2] = 19.0;
            numArray[3] = 17.0;
            this.pictureBox1.Image = (Image)Resources.andhrapradesh;
            break;
          case "maharashtra":
            numArray[0] = 16.0;
            numArray[1] = 19.0;
            numArray[2] = 22.0;
            numArray[3] = 19.0;
            this.pictureBox1.Image = (Image)Resources.maharashtra;
            break;
          case "haryana":
            numArray[0] = 17.0;
            numArray[1] = 21.0;
            numArray[2] = 25.0;
            numArray[3] = 21.0;
            this.pictureBox1.Image = (Image)Resources.haryana;
            break;
          case "ulysses, ks":
            numArray[0] = 13.0;
            numArray[1] = 17.0;
    ...
    private bool LoadDefaultLocations()
    {
      ...
      locationData1.LocationName = "Uttarpradesh";
      ...
      locationData2.LocationName = "Punjab";
      ...
      locationData3.LocationName = "Haryana";
      ...
      locationData4.LocationName = "Madhyapradesh";
      ...
      locationData5.LocationName = "Maharashtra";
      ...
      locationData6.LocationName = "Andhrapradesh";
    ...
    private void RefreshBound()
    {
      ...
      this.linkPrice.Text = this.mainCWY.ActiveCrop != null ? "Rs" + this.mainCWY.ActiveCrop.price.ToString() + "/" + this.mainCWY.ActiveCrop.Units() : "";
