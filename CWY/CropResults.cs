...
namespace CWY
{
  public class CropResults : UserControl
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.printToolStripMenuItem.Image = (System.Drawing.Image) Resources.printer;
      ...
      this.sToolStripMenuItem.Image = (System.Drawing.Image) Resources.page_white_excel;
      ...
      this.helpToolStripMenuItem.Image = (System.Drawing.Image) Resources.help;
      ...
      this.printToolStripMenuItem1.Image = (System.Drawing.Image) Resources.printer;
      ...
      this.helpToolStripMenuItem1.Image = (System.Drawing.Image) Resources.help;
      ...
      this.printToolStripMenuItem2.Image = (System.Drawing.Image) Resources.printer;
      ...
      this.helpToolStripMenuItem2.Image = (System.Drawing.Image) Resources.help;
      ...
      this.printToolStripMenuItem3.Image = (System.Drawing.Image) Resources.printer;
      ...
      this.helpToolStripMenuItem3.Image = (System.Drawing.Image) Resources.help;
      ...
      this.printToolStripMenuItem4.Image = (System.Drawing.Image) Resources.printer;
      ...
      this.helpToolStripMenuItem4.Image = (System.Drawing.Image) Resources.help;
      ...
      this.helpToolStripMenuItem5.Image = (System.Drawing.Image) Resources.help;
    ...
    public void LoadCropResults()
    {
      ...
      try
      {
        ...
        else
        {
          ...
          var dateFromString = (System.ValueType) bindingList[0].GetDateFromString(bindingList[0].arrCoefficients[0].Date);
          dateTime1 = bindingList[0].GetDateFromString(bindingList[0].arrCoefficients[bindingList[0].arrCoefficients.Count - 1].Date);
          // ISSUE: variable of a boxed type
          var local = (System.ValueType) dateTime1.AddYears(num3);
          ...
          while (enumerator.MoveNext())
          {
            ...
            foreach (InputCost cGeneralCost in (Collection<InputCost>) crop.cGeneralCosts)
            {
              ...
              if (cost.Count > 0)
              {
                ...
                this.AddRowCR(cost[0].ToString(), "Rs" + ((double) cost[1]).ToString("0.00") + "/" + str8);
              }
            }
            foreach (InputCost cOperationCost in (Collection<InputCost>) crop.cOperationCosts)
            {
            ...
            this.AddRow("Gross Return", "Rs" + num26.ToString("0") + "/" + str8);
            this.AddRow("Total Operating Costs", "Rs" + num24.ToString("0") + "/" + str8);
            this.AddRow("Net Return", "Rs" + num27.ToString("0") + "/" + str8);
    ...
    public static void CreateWorkbook(string filePath, DataSet dataset)
    {
      ...
      foreach (DataTable table in (InternalDataCollectionBase) dataset.Tables)
      {
        ...
        for (int index1 = 0; index1 < table.Columns.Count; ++index1)
        {
                    ...
                    worksheet.Cells[0,index1]=new Cell((object)table.Columns[index1].ColumnName);
                    for (int index2 = 0; index2 < table.Rows.Count; ++index2)
                    worksheet.Cells[index2 +1,index1]=new Cell((object)table.Rows[index2][index1].ToString());
